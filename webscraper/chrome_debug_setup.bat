...
powershell -Command "if (-not (Get-NetFirewallRule -DisplayName 'Chrome DevTools 9222' -ErrorAction SilentlyContinue)) { New-NetFirewallRule -DisplayName 'Chrome DevTools 9222' -Direction Inbound -LocalPort 9222 -Protocol TCP -Action Allow }"
